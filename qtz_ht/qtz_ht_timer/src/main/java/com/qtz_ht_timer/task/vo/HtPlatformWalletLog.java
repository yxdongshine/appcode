...
public class HtPlatformWalletLog extends VO<Long> implements java.io.Serializable {
	...
	public HtPlatformWalletLog(Long busiId, Long orderId, Double amount, Integer incomeType, Integer paymentType,
			Double platformPoints, Long incomeTime, Long releaseTime, Integer recoStatus, Long crtime) {
		super();
		this.busiId = busiId;
	...
	public String toString() {
	    return "[" + "dmId:" + getDmId() +"," + "busiId:" + getBusiId() +"," + "orderId:" + getOrderId() +"," + "amount:" + getAmount() +"," + "incomeType:" + getIncomeType() +"," + "paymentType:" + getPaymentType() +"," + "platformPoints:" + getPlatformPoints() +"," + "incomeTime:" + getIncomeTime() +"," + "releaseTime:" + getReleaseTime() +"," + "recoStatus:" + getRecoStatus() +"," + "crtime:" + getCrtime() +"]";
	}
}